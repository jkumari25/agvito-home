...
export const DarkModeSwitch = ({ className }: { className?: string }) => {
  ...
  return (
    <button
      ...
      className={cn(
        "group mr-2 flex h-9 w-9 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent hover:bg-primary focus:border-transparent focus:bg-primary dark:border-transparent dark:bg-white/[.15] dark:hover:bg-primary lg:ml-5",
        className,
      )}
